            ...
            <div className="container mx-auto px-4">
                ...
                <div className="relative">
                    ...
                    {steps.map((step, index) => (
                        <div key={step.step} className="relative mb-6 md:mb-10 flex flex-col md:flex-row items-center justify-center">
                            {/* Content */}
                            <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:pl-8 md:text-left'} text-center`}>
                                <h3 className="text-2xl font-headline font-bold mb-1">{step.title}</h3>
                                <p className="text-muted-foreground">{step.description}</p>
                            </div>
                            
                            {/* Icon & Number */}
                            <div className="absolute left-1/2 -translate-x-1/2 flex items-center justify-center bg-background z-10 my-2 md:my-0">
